...
import com.set_job_portal.Service.ApplicationService;
...
public class ApplicationController
{
	...
	public ResponseEntity<String>apply(@RequestBody ApplicationDTO dto)
	{
		...
		return ResponseEntity.ok("Application got Submited");
	}
	...
	public ResponseEntity<String>upateStatus(@RequestParam Long id,@RequestParam ApplicationStatus status)
	{ 
